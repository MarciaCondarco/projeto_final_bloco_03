...
function Footer() {
    ...
    return (
        ...
        <div className="flex justify-center w-full px-2 text-black bg-lime-200 py-4 mt-auto">
            <div className="container flex flex-col items-center gap-2">
                <p className='text-base font-bold text-center md:text-xl'>Farmacia VIDA | Copyright: {data}</p>
